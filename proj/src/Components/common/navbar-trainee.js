	...
	return (
			<div>
				...
				<NavDropdown title="">
					...
					<Nav.Link href="/PersonalFile/:SSN">الملف الشخصي</Nav.Link>

<Nav.Link href="/traineecourse">دوراتي</Nav.Link>
...
export default AppNavbarTrainee;
